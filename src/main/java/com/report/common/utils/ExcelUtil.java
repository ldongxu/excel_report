...
public class ExcelUtil {
    ...
    public static <T> Collection<T> readExcel(InputStream inputStream) throws IOException, InvalidFormatException, IllegalAccessException, InstantiationException, ClassNotFoundException {
        Workbook workbook = WorkbookFactory.create(inputStream);
        Iterator<Sheet> iterator = workbook.sheetIterator();
        while (iterator.hasNext()) {
            Sheet sheet = iterator.next();
            String sheetName = sheet.getSheetName();
            Class clazz = SheetNameEnum.getClass(sheetName);
